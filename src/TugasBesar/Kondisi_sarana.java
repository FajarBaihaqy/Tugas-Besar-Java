...
public class Kondisi_sarana extends Ruangan implements deklarasi{
    
    public Kondisi_sarana(String kondisi) {
        super(kondisi);
    }
    ...
    void manage1() {
        ...
        setNama_ruang(scan.nextLine());
        System.out.print("Masukan lokasi ruang :");
        setLokasi_ruang(scan.nextLine());
